...
window.SKILL_TIERS={
  ...
  'dan-dan-noodles':{level:'capable',why:'Sichuan noodles — chilli oil, preserved veg',skills:['noodle cookery','chilli oil','preserved vegetable','pork mince']},
  'tom-yum-goong':{level:'capable',why:'Thai soup — chilli, lime, lemongrass, prawn',skills:['stock','aromatic balance','prawn timing','acid heat']},
