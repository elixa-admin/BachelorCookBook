...
window.SA_INGREDIENT_COST_VARIANTS = {
  ...
  "protein.beef.fillet.steak": {
    ...
    adjustment_notes:
      "Braise low-slow instead of searing; adds tenderness through cooking. Not for quick sears.",
    best_for: ["braising", "stews", "tagine", "red wine reduction"],
    avoid_for: ["fillet steak showcase", "carpaccio", "rare showcases"],
    retailer_tip:
      "Local butcher chuck better marbled; ask for blade steak section",
  },
  ...
  "protein.chicken.breast.boneless": {
    ...
    adjustment_notes:
      "More forgiving; stays moist even if overcooked. Slightly gamey flavor. Better in curries, braising.",
    best_for: ["curries", "braising", "casseroles", "rustic dishes"],
    avoid_for: ["delicate sauces", "light preparations"],
    retailer_tip:
      "All retailers stock; thighs more flavorful and cheaper year-round",
  },
  ...
  "protein.lamb.leg.whole": {
    ...
    quality_tradeoff: "minimal",
    adjustment_notes:
      "More marbling; shorter braising time. Even more forgiving than leg. Better for tagine.",
    best_for: ["tagine", "braising", "slow-roast", "curries"],
    avoid_for: ["leg roast showcase (if quality matters)"],
    retailer_tip:
      "Local butcher has best shoulder; spring lamb season (Sep-Nov) is still good value",
  },
  ...
  "protein.fish.kingklip.fillet": {
    ...
    adjustment_notes:
      "More delicate; don't overcook. Similar prep but watch timing. Good for en papillote.",
    best_for: ["steaming", "poaching", "en papillote", "butter sauces"],
    avoid_for: ["heavy creams", "strong flavors that mask delicacy"],
    retailer_tip:
      "Hake peak Jun-Sep (cheaper); kingklip more consistent year-round",
  },
  ...
  "dairy.cream.double": {
    ...
    quality_tradeoff: "minimal",
    adjustment_notes:
      "Lower fat; won't whip to stiff peaks. Better for cooking (sauces, custards) than whipping.",
    best_for: ["cream sauces", "custard", "enrichment", "cooking"],
    avoid_for: ["whipped cream", "chantilly"],
    retailer_tip:
      "Cooking cream sufficient for most savory dishes; save double for desserts",
  },
  ...
  "dairy.cheese.feta": {
    ...
    quality_tradeoff: "significant",
    adjustment_notes:
      "Creamier, less salty. Use for spanakopita filling, but not Mediterranean salads.",
    best_for: ["spanakopita filling", "lasagne", "enrichment"],
    avoid_for: ["Greek salad", "breakfast spreads", "crumbly garnish"],
    retailer_tip:
      "Ricotta available at all retailers; feta from local dairies is better quality",
  },
  ...
  "dairy.cheese.cheddar": {
    ...
    quality_tradeoff: "significant",
    adjustment_notes:
      "Melts instantly (emulsifiers); less rich flavor. Only for mac-and-cheese, burgers.",
    best_for: ["mac-and-cheese", "burgers", "quick melts"],
    avoid_for: [
      "cheese boards",
      "adult entertaining",
      "any dish celebrating cheese",
    ],
    retailer_tip:
      "Budget brands (PnP brand) vs. Kraft; real cheddar 10-15% more but much better taste",
  },
  ...
  "produce.asparagus": {
    ...
    quality_tradeoff: "significant",
    adjustment_notes:
      "Different flavor (grassy vs. nutty). Use similar prep (butter, lemon).",
    best_for: [
      "side dish with butter",
      "seasonal substitute",
      "budget entertaining",
    ],
    avoid_for: ["asparagus-specific dishes", "spring entertaining"],
    retailer_tip:
      "Use Sep-Nov when asparagus is cheap; green beans year-round alternative",
  },
  ...
  "produce.tomato.fresh": {
    ...
    quality_tradeoff: "noticeable",
    adjustment_notes:
      "Use for sauces, curries (cooked dishes). Not for fresh salads or garnish.",
    best_for: ["ragù", "tagine", "curry", "bolognese", "braising liquid"],
    avoid_for: ["fresh tomato salad", "gazpacho", "garnish"],
    retailer_tip:
      "Canned passata / crushed tomatoes year-round; fresh only Dec-Mar affordable",
  },
  ...
  "produce.bell-pepper.red": {
    ...
    quality_tradeoff: "noticeable",
    adjustment_notes:
      "Softer texture; use in cooked dishes (curry, stew). Not for fresh salad.",
  ...
  "produce.lemon.fresh": {
    ...
    quality_tradeoff: "significant",
    adjustment_notes:
      "Sharper acidity; use half the amount. Not 1:1 swap. Good for marinades, dressings.",
  ...
  "produce.spinach.fresh": {
    ...
    quality_tradeoff: "noticeable",
    adjustment_notes:
      "Pre-cooked, soggy; use for spanakopita, curries, soups. Not for fresh salads.",
    best_for: ["spanakopita", "curries", "soups", "enrichment"],
    avoid_for: ["fresh salads", "garnish", "raw applications"],
    retailer_tip:
      "Fresh spinach wilts quickly (R16-24); frozen stable (R12-16)",
  },
  ...
  "pantry.olive-oil.extra-virgin": {
    ...
    quality_tradeoff: "significant",
    adjustment_notes:
      "Neutral flavor; use for cooking. Finish dishes with cheaper oil; save EVOO for drizzle.",
    best_for: ["cooking", "sautéing", "frying"],
    avoid_for: ["finishing", "drizzle", "salads"],
    retailer_tip:
      "Use cooking oil for heat; budget EVOO (Woolworths R65) for most dishes",
  },
  ...
  "pantry.rice.white.basmati": {
    ...
    quality_tradeoff: "noticeable",
    adjustment_notes:
      "Chunkier; more starch release. Use for risotto, congee. Not for biryani.",
    best_for: ["everyday rice", "risotto", "congee", "budget meals"],
    avoid_for: ["biryani", "pilau", "special occasions"],
    retailer_tip:
      "Basmati for entertaining; short-grain for everyday (R12/kg vs R28/kg)",
  },
  ...
  "condiment.vinegar.balsamic": {
    ...
    quality_tradeoff: "significant",
    adjustment_notes:
      "Sharp, not sweet. Use for pickling, marinades. Not for glazes.",
    best_for: ["pickling", "marinades", "dressings"],
    avoid_for: ["balsamic glaze", "finishing, showcasing"],
    retailer_tip:
      "Use white vinegar for cooking; balsamic for finish only (R35+)",
  },
  ...
  "produce.herb.parsley.fresh": {
    ...
    quality_tradeoff: "noticeable",
    adjustment_notes:
      "Use 1/3 the amount (concentrate). Better for cooked dishes; worse for garnish.",
    best_for: ["soups", "stews", "cooked garnish"],
    avoid_for: ["fresh garnish", "salads", "garnish where freshness matters"],
    retailer_tip:
      "Fresh parsley bunches (R8) wilt quickly; dried (R2) indefinite",
  },
  ...
  "produce.herb.basil.fresh": {
    ...
    quality_tradeoff: "significant",
    adjustment_notes:
      "Muted flavor; use 1/3 amount. Better for tomato-based dishes (lose fresh pop).",
    best_for: ["tomato sauce", "pasta sauce", "braising"],
    avoid_for: ["pesto", "fresh garnish", "delicate salads"],
    retailer_tip:
      "Fresh basil (R12 bundle) for pesto; dried (R2-3) for cooking",
  },
  ...
  "produce.herb.thyme.fresh": {
    ...
    quality_tradeoff: "minimal",
    adjustment_notes:
      "Use 1/3 amount. Works well in all thyme applications (braising, roasting).",
    best_for: ["braising", "slow-cook", "roasting", "stew"],
    avoid_for: ["fresh garnish"],
    retailer_tip:
      "Fresh thyme (R15/bunch) vs. dried (R2-3/40g); dried works nearly as well",
  },
  ...
  "produce.herb.rosemary.fresh": {
    ...
    quality_tradeoff: "minimal",
    adjustment_notes:
      "Use 1/2 amount (intense even dried). Add early to cooking.",
  ...
  "protein.egg.large": {
    ...
    quality_tradeoff: "minimal",
    adjustment_notes:
      "Nutritionally identical; shell color only. PnP brand vs. free-range.",
    best_for: ["all egg applications"],
    avoid_for: ["none"],
    retailer_tip:
      "Standard brown eggs R43/dozen; free-range R65-75; no quality difference for cooking",
  },
...
console.log(
  "✅ SA Ingredient Cost Variants loaded. " +
    Object.keys(window.SA_INGREDIENT_COST_VARIANTS).length +
    " ingredients with budget alternatives."
);
